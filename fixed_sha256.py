"""Fixed SHA-256 implementation with correct K[62]."""

import struct
import hashlib

# FIXED K constants - K[62] = 0xbef9a3f7 (not 0xbef9a3f9)
K = [
...
# Test
tests = [b"", b"abc", b"josh", b"a"*55, b"a"*56, b"a"*64]
all_pass = True
for msg in tests:
