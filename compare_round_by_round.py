"""Compare round by round against a reference implementation."""
...
def sha256_with_trace(message):
    """SHA-256 with detailed trace output."""
...
# Use a web-sourced test vector to verify
# SHA-256("") = e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855
# SHA-256("abc") = ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad

import hashlib

for test in [b"", b"abc", b"josh"]:
    ref = hashlib.sha256(test).hexdigest()
    mine = sha256_with_trace(test)
    match = "OK" if ref == mine else "MISMATCH"
    print(f"SHA256({test!r}): {match}")
    if ref != mine:
