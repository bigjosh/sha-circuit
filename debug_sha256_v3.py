"""Debug by comparing with a known good implementation."""
...
def sha256_reference(data):
    """Use Python's hashlib as reference."""
...
if __name__ == "__main__":
    ...
    ref = sha256_reference(message)
    manual = sha256_manual(message)

    print(f"Reference: {ref}")
    print(f"Manual:    {manual}")
    print(f"Match: {ref == manual}")
